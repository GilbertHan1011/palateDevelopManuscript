csvfile <- list.files("process/regulation/20250107_celloracle/20250110_pertubation_score/",full.names = T, pattern = "*.csv")
name <- list.files("process/regulation/20250107_celloracle/20250110_pertubation_score/",full.names = F, pattern = "*.csv") %>% gsub(".csv","",.)
...
pdf("process/regulation/20250110_celloracle//purtubation_score.pdf",width = 6,height = 25)
